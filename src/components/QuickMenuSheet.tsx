...
import { Home, Package, Users, UserCircle, Wallet, ArrowUpRight, ArrowDownRight, Ticket, Landmark, BarChart3, Settings, Headphones, Share2, Crown, Building2 } from "lucide-react";
            ...
            <div key={group.title}>
              ...
              <div className="grid grid-cols-4 gap-3">
                {group.items.map((item) => (
                  <button key={item.label} onClick={() => handleNavigate(item.path)} className="flex flex-col items-center gap-2 p-3 rounded-xl bg-muted/50 hover:bg-muted transition-colors">
